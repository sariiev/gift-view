...
from gift_view.aggregation.aggregators import GiftModelPriceBarAggregator
...
class GiftModelPriceBarAggregationJob:
    def __init__(
            self,
            aggregator: GiftModelPriceBarAggregator,
            intervals: List[str]
    ):
    ...
    async def main(self):
        self.scheduler.add_job(
            ...
            id="gift_model_price_bar_aggregator",
            max_instances=1,
            coalesce=True
        )
...
if __name__ == '__main__':
    ...
    job = GiftModelPriceBarAggregationJob(
